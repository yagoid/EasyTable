...
public class ControllerAdminHomepage {
    ...
    public void openAdminRegister() {
    	try {
			FXMLLoader loader = new FXMLLoader(getClass().getResource("../views/AdminRegister.fxml"));
			view = loader.load();
			Stage st = new Stage();
			st.setScene(new Scene(view));
			st.centerOnScreen();
    ...
    public void openEliminarUsuarios() {
    	try {
			FXMLLoader loader = new FXMLLoader(getClass().getResource("../views/AdminEliminarUsers.fxml"));
			view = loader.load();
			Stage st = new Stage();
			st.setScene(new Scene(view));
			st.centerOnScreen();
